...
import bgImg from '../assets/Illustrationvs3.png'
    ...
    <div name='home' className='w-full h-screen bg-zinc-200 flex flex-col justify-between'>
        <div className='grid md:grid-cols-2 max-w-[1240px] m-auto'>
            <div className='flex flex-col justify-center md:items-start w-full px-2 py-8'>
                ...
                <h1 className='py-3 text-5xl md:text-7xl font-bold'>SylvieLism's Character</h1>
                <p className='text-2xl'>This is out Tech brand.</p>
                <button className='py-3 px-6 sm:w-[60%] my-4'>Get Started</button>
            </div>
            <div>
                <img class='w-full' src={bgImg} alt="" />
            </div>
            ...
            border border-slate-300 rounded-xl text-center shadow-xl'>
                ...
                <div className='flex justify-between flex-wrap px-4'>
                    ...
                    <p className='flex px-4 py-2 text-slate-500'><ShareIcon className='h-6 text-indigo-600'/> Cloud Data</p>
