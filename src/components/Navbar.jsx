    ...
    <div className='w-screen h-[80px] z-10 bg-zinc-200 fixed drop-shadow-lg'>
        <div className='px-2 flex justify-between item-center w-full h-full'>
            <div className='flex items-center'>
                <h1 className='text-3xl font-bold mr-4 sm:text-4xl'>Sylvielism</h1>
            ...
            <div className='hidden md:flex pr-4'>
                ...
                <button className='px-8 my-4'>Sign Up</button>
            </div>
            <div className='md:hidden flex items-center pr-5' onClick={handleClick}>
